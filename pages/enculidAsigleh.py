...
clave = st.session_state['clave']+'_'+st.session_state['rol']
...
st.header('Encuesta de Liderazgo Eclesial de ASIGLEH 2023')
...
msgBienv = "<h4 style='text-align: left; color: orange;'>Bienvenido usuario : "+ clave + " </h4>"
#msgBienv
