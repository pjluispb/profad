...
with st.expander('Datos acerca de su testimonio'):
    with st.form(key='dattesti'):
        fec_conversion = st.date_input('Fecha de Conversión', min_value=datetime.date(1940,1,1), value=datetime.datetime.strptime(valores['fec_conversion'], "%d/%m/%Y"), max_value=datetime.datetime.now())
        fec_bautismo_agua = st.date_input('Fecha de Bautismo en agua', min_value=datetime.date(1940,1,1), value=datetime.datetime.strptime(valores['fec_bautismo_agua'], "%d/%m/%Y"))
        fec_bautismo_Espiritu = st.date_input('Fecha de Bautismo en el Espiritu Santo', min_value=datetime.date(1940,1,1), value=datetime.datetime.strptime(valores['fec_bautismo_Espiritu'], "%d/%m/%Y"))
        testimonio = st.text_area('Compártenos tu testimonio de salvación', value=valores['testimonio'])
        st.write('---')
        llamado = st.text_area('Compártenos tu testimonio acerca de tu llamado ministerial. ¿Cómo, cuándo y dónde  inició su ministerio?', value = valores['llamado'])
        st.write('---')
...
with st.expander('Datos sobre su trabajo ministerial'):
    with st.form(key='dattrab'):
        indcategomin = ['Ministro Distrital', 'Ministro Cristiano', 'Ministro Licenciado', 'Ministro Ordenado', 'No se'].index(valores['categomin'])
        categomin = st.radio(label='Categoría Ministerial Actual:', options=['Ministro Distrital', 'Ministro Cristiano', 'Ministro Licenciado', 'Ministro Ordenado', 'No se'], index=indcategomin)
        col1, col2 = st.columns(2)
        #cargo1=st.container()
        minist_1 = st.text_input('Ministerio desempeñado ó actual', key='minist1', value=valores['minist_1'])
        orgigle_1 = st.text_input('Iglesia / Organización / Departamento ó Ministerio', key='iglem1', value=valores['orgigle_1'])
        ...
        descripmin_1 = st.text_area('Breve descripción del trabajo desempeñado', key='descri1', value=valores['descripmin_1'])
        st.write('---')
        minist_2 = st.text_input('Ministerio desempeñado ó actual', key='minist2', value=valores['minist_2'])
        orgigle_2 = st.text_input('Iglesia / Organización / Departamento ó Ministerio', key='iglem2', value=valores['orgigle_2'])
        ...
        descripmin_2 = st.text_area('Breve descripción del trabajo desempeñado', key='descri2', value=valores['descripmin_2'])
        st.write('---')
        minist_3 = st.text_input('Ministerio desempeñado ó actual', key='minist3', value=valores['minist_3'])
        orgigle_3 = st.text_input('Iglesia / Organización / Departamento ó Ministerio', key='iglem3', value=valores['orgigle_3'])
        ...
        descripmin_3 = st.text_area('Breve descripción del trabajo desempeñado', key='descri3', value=valores['descripmin_3'])
        st.write('---')
        minist_4 = st.text_input('Ministerio desempeñado ó actual', key='minist4', value=valores['minist_4'])
        orgigle_4 = st.text_input('Iglesia / Organización / Departamento ó Ministerio', key='iglem4', value=valores['orgigle_4'])
        ...
        descripmin_4 = st.text_area('Breve descripción del trabajo desempeñado', key='descri4', value=valores['descripmin_4'])
        st.write('---')
        minist_5 = st.text_input('Ministerio desempeñado ó actual', key='minist5', value=valores['minist_5'])
        orgigle_5 = st.text_input('Iglesia / Organización / Departamento ó Ministerio', key='iglem5', value=valores['orgigle_5'])
        ...
        descripmin_5 = st.text_area('Breve descripción del trabajo desempeñado', key='descri5', value=valores['descripmin_5'])
        st.write('---')
        ...
        if guarda05:
            ...
            update_reg_dattrabmini(categomin, minist_1, orgigle_1, tiempominist_1, descripmin_1, minist_2, orgigle_2, tiempominist_2, descripmin_2, minist_3, orgigle_3, tiempominist_3, descripmin_3, minist_4, orgigle_4, tiempominist_4, descripmin_4, minist_5, orgigle_5, tiempominist_5, descripmin_5, otrostrabmin)
