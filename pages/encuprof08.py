...
with st.expander('Datos acerca de su testimonio'):
    with st.form(key='dattesti'):
        ...
        fec_bautismo_agua = st.date_input('Fecha de Bautismo en agua', format = 'DD/MM/YYYY', value=datetime.strptime(valores['fec_bautismo_agua'], "%d/%m/%Y"))
        fec_bautismo_Espiritu = st.date_input('Fecha de Bautismo en el Espíritu Santo', format = 'DD/MM/YYYY', value=datetime.strptime(valores['fec_bautismo_Espiritu'], "%d/%m/%Y"))
